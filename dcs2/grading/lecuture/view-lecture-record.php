...
<head>
    ...
    <title>Display Grades Data</title>
    <style>
        body {
        ...
        form select {
            padding: 8px; /* Slightly larger size for the filter */
        }
...
<body>
    ...
    echo '<option value="all" ' . ($filter == 'all' ? 'selected' : '') . '>Select Type</option>';
    ...
    <div class="go-back-button">
        <a href="../../faculty/faculty-dashboard.php">Back to Dashboard</a>
    </div>

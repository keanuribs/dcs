...
<head>
  ...
  <!-- 
    - favicon
  -->
  <link rel="shortcut icon" href="assets/img/dcss.png" type="image">
...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      <a href="#" class="logo">
        <img src="assets/img/dcs-logo-with-text.png" width="162" height="40" alt="DCS logo">
      </a>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item" id="login-dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="students/student-login.php">Student Login</a></li>
              <li><a href="faculty/faculty-login.php">Teacher Login</a></li>
            </ul>
          </li>
        </ul>
      </nav>
  ...
  <main>
    <article>
      ...
      style="background-image: url('assets/img/deppic.jpg')">
<div class="container">
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="course-card">
                ...
                <figure class="card-banner img-holder" style="--width: 370; --height: 150;">
                  <img src="assets/img/bsit.jpg" width="150" height="150" loading="lazy"
            ...
            <li>
              <div class="course-card">
                ...
                <figure class="card-banner img-holder" style="--width: 370; --height: 150;">
                  <img src="assets/img/css.jpg" width="150" height="150" loading="lazy"
    ...
    <div class="footer-top section">
      <div class="container grid-list">
        ...
        <div class="footer-brand">
          ...
          <a href="#" class="logo">
            <img src="assets/img/dcss.png" width="50" height="50" alt="EduWeb logo">
          </a>
  ...
  <!-- 
    - custom js link
  -->
  <script src="assets/indexscript.js" defer></script>
